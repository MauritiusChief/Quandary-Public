...
public class FuncDef extends ASTNode {
    ...
    public String getName() {
        return this.varDecl.getIdent().getIdentStr();
        // return this.name;
    }
    ...
    public String toString() {
        if (formalDeclList == null){
            return varDecl.getIdent().getIdentStr() + "() {" + body.toString()+"}" ;
        }
        return varDecl.getIdent().getIdentStr() + "(" + formalDeclList.toString()+") {"+body.toString()+"}";
    }
}